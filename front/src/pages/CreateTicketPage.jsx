        ...
        <div style={{ padding: 16, display: "grid", gap: 16, maxWidth: 1000, margin: "0 auto" }}>
            ...
            {showPerson && (
                <div style={{ border: "1px solid #ddd", borderRadius: 8, padding: 12 }}>
                    ...
                    <CreatePersonPanel onCreated={() => { setShowPerson(false); bumpDicts(); }} />
                </div>
            )}
            ...
            {showEvent && (
                <div style={{ border: "1px solid #ddd", borderRadius: 8, padding: 12 }}>
                    ...
                    <CreateEventPanel onCreated={() => { setShowEvent(false); bumpDicts(); }} />
                </div>
            )}
            ...
            {showVenue && (
                <div style={{ border: "1px solid #ddd", borderRadius: 8, padding: 12 }}>
                    ...
                    <CreateVenuePanel onCreated={() => { setShowVenue(false); bumpDicts(); }} />
                </div>
            )}
